...
require_once $_SERVER['DOCUMENT_ROOT']=('./../modelo/dao/conexion.php');
require_once $_SERVER['DOCUMENT_ROOT']=('./../modelo/dao/procesaParametros.php');
require_once $_SERVER['DOCUMENT_ROOT']=('./../modelo/dao/usuario/usuariosSql.php');
require_once $_SERVER['DOCUMENT_ROOT']=('./../vista/logicavista/notificationView.php');
